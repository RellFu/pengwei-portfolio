...
export const featuredProjects: CaseStudyProject[] = [
  ...
  },
  {
    ...
    summary: "Built a quality operating loop for a creative AI agent—connecting product analytics, layered Agent evaluation, and expert-workflow productization.",
    ...
    role: "As an AI Product Manager Intern, I built the product evaluation framework and analytics dashboards, led recurring feedback analysis, audited the vertical Skill system, built a reusable evaluator, and contributed to layered Agent evaluation.",
    solution: "Created a five-stage quality loop—observe, diagnose, formalize, validate, and prioritize.",
    ...
    metrics: [
      ...
      { label: "Task segments evaluated", value: "35" },
    ],
    impact: [
      ...
      "Calibrated a layered Task → Query → Agent → Skill → Sub-agent evaluation model.",
    ],
    architecture: [
      ...
      { title: "Prioritize", description: "Turn patterns into product decisions." },
    ],
    keyDecisions: [
