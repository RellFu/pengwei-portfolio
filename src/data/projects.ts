...
export const featuredProjects: CaseStudyProject[] = [
  ...
  },
  {
    ...
    summary: "Built and deployed a quality system for a creative AI Agent—from task-level evaluation and expert-method Skills to ecosystem governance, recurring instrumentation patrol, and structured knowledge.",
    overview: "At Alibaba's Youku AI Content Creation team, I worked on Phai, a creative AI agent for professional content workflows.",
    ...
    role: "As an AI Product Manager Intern, I independently audited all 55 Skills and built skill-evaluator; owned product design, Prompt/Skill authoring, and test iteration for the Three-Act and Bible Skills; designed and configured the instrumentation patrol; and proposed the knowledge Schema through review.",
    ...
    metrics: [
      ...
      { label: "Query-response labels", value: "91" },
      { label: "Task segments evaluated", value: "34" },
    ],
    impact: [
      "Built a product-health framework spanning six analytical views.",
      "Audited 55 vertical AI Skills across 10 engineering dimensions.",
      "Decomposed a 119-turn session into 34 tasks and calibrated a layered Task → Query → Agent → Skill → Sub-agent evaluation model.",
      "Designed and configured an instrumentation patrol that runs on a recurring schedule and reports to the work group.",
    ],
    architecture: [
