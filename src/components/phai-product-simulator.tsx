...
const agentChats: Record<AgentId, { author: "user" | "agent"; text: string; thinking: string }[]> = {
  storyboard: [
    { author: "user", text: "Scene 32 needs to land without a question. Can you sketch what the camera should do?", thinking: "" },
    { author: "agent", thinking: "Mapped Scene 32 to lens + blocking", text: "Wide on desk plus evidence bag first. Hold still, then push in only when the suspect corrects the label. Detective hears it and smiles. End of scene, no dialogue reveal. Five shots total, one cut." },
  ],
  dialogue: [
    { author: "user", text: "The detective line ‘Where is the camera cage?’ feels too on the nose. Can you rework it?", thinking: "" },
    { author: "agent", thinking: "Audited 3 candidate rewrites", text: "Cut it. The suspect already knows the cage, so give her only: ‘I mislabeled it.’ The detective picks up the phrase, scene ends. One line, one beat." },
  ],
  engineer: [
    { author: "user", text: "If we drop the detective’s question, does the camera cage fact still reach Scene 41?", thinking: "" },
    { author: "agent", thinking: "Traced 2 downstream dependencies", text: "Yes, but only if the suspect’s correction still contains the phrase ‘camera cage.’ That phrase is what seeds Scene 41. Keep it inside the line, drop everything else." },
  ],
  research: [
    { author: "user", text: "Is the camera cage a real 1980s prop, or am I inventing it?", thinking: "" },
    { author: "agent", thinking: "Cross-checked 4 archival sources", text: "Camera cages existed in 1980s broadcast studios as protective rigs. Cite a 1984 BBC engineering memo and a Sony BVP handbook page. Safe to use on screen." },
  ],
};
...
const knowledgeWorks = [
  { title: "The Devil Wears Prada", year: "2006", track: "Drama", genre: "Workplace", mark: "DWP", color: "from-[#ef4444] to-[#7f1d1d]", poster: "/images/posters/devil-wears-prada.jpg", summary: "An aspiring journalist enters a fashion empire and discovers the cost of mastering a world she dismisses." },
  { title: "Wednesday", year: "2022", track: "Mystery", genre: "Coming-of-age", mark: "W", color: "from-[#667085] to-[#111827]", poster: "/images/posters/wednesday.jpg", summary: "A fiercely independent student investigates a supernatural mystery while resisting every attempt at belonging." },
  { title: "The Queen’s Gambit", year: "2020", track: "Drama", genre: "Coming-of-age", mark: "QG", color: "from-[#d97706] to-[#451a03]", poster: "/images/posters/queens-gambit.png", summary: "A chess prodigy’s ascent turns talent, addiction, and intimacy into one tightly linked character engine." },
  { title: "The Walking Dead", year: "2010", track: "Adventure", genre: "Survival", mark: "WD", color: "from-[#78716c] to-[#292524]", poster: "/images/posters/walking-dead.jpg", summary: "Survival pressure repeatedly reorganizes leadership, loyalty, and the meaning of community." },
  { title: "Black Mirror", year: "2011", track: "Sci-fi", genre: "Anthology", mark: "BM", color: "from-[#0f172a] to-[#0284c7]", poster: "/images/posters/black-mirror.jpg", summary: "Standalone stories turn a single technology premise into a social and moral stress test." },
  { title: "The Last of Us", year: "2023", track: "Adventure", genre: "Survival", mark: "LU", color: "from-[#3f6212] to-[#1c1917]", poster: "/images/posters/last-of-us.jpg", summary: "A transport mission gradually becomes a parent-child bond under escalating ethical cost." },
  { title: "The White Lotus", year: "2021", track: "Comedy", genre: "Satire", mark: "WL", color: "from-[#0891b2] to-[#164e63]", poster: "/images/posters/white-lotus.png", summary: "An ensemble vacation uses status rituals and small humiliations to reveal a larger class system." },
  { title: "The Bear", year: "2022", track: "Drama", genre: "Workplace", mark: "TB", color: "from-[#1d4ed8] to-[#172554]", poster: "/images/posters/the-bear.png", summary: "A chef inherits a chaotic restaurant where grief, craft, and team systems collide in real time." },
  { title: "Sherlock", year: "2010", track: "Mystery", genre: "Detective", mark: "SH", color: "from-[#475569] to-[#020617]", poster: "/images/posters/sherlock.jpg", summary: "Deduction becomes action through clue hierarchies, adversarial reveals, and an evolving partnership." },
  { title: "Better Call Saul", year: "2015", track: "Drama", genre: "Crime", mark: "BCS", color: "from-[#f59e0b] to-[#991b1b]", poster: "/images/posters/better-call-saul.jpg", summary: "A character tragedy tracks how small tactical compromises accumulate into an identity." },
  { title: "Parasite", year: "2019", track: "Thriller", genre: "Class", mark: "P", color: "from-[#166534] to-[#052e16]", poster: "/images/posters/parasite.png", summary: "A family’s infiltration plot turns architectural space into a visible model of class mobility." },
  { title: "Spirited Away", year: "2001", track: "Adventure", genre: "Fantasy", mark: "SA", color: "from-[#fb7185] to-[#7e22ce]", poster: "/images/posters/spirited-away.png", summary: "A child’s moral growth is encoded in the rules, labor, and transformations of a spirit world." },
] as const;
...
const models = [
  { name: "Tongyi Qianwen", maker: "Alibaba", mark: "QW", logo: "/images/models/qwen.svg" },
  { name: "Gemini", maker: "Google", mark: "GE", logo: "/images/models/gemini.svg" },
  { name: "ChatGPT", maker: "OpenAI", mark: "CG", logo: "/images/models/openai.svg" },
  { name: "Claude", maker: "Anthropic", mark: "CL", logo: "/images/models/claude.svg" },
  { name: "DeepSeek", maker: "DeepSeek", mark: "DS", logo: "/images/models/deepseek.svg" },
  { name: "Doubao", maker: "ByteDance", mark: "DB", logo: "/images/models/doubao.svg" },
];
      ...
      <aside className="hidden min-h-0 bg-[#fbfbfc] lg:grid lg:grid-rows-2">
        ...
        <div className="min-h-0 p-3.5">
          ...
          <div className="mt-3 rounded-xl border border-black/8 bg-white p-3 shadow-sm">
            <div className="flex items-start gap-2"><span className="flex h-7 w-7 items-center justify-center rounded-lg bg-[#eaf4ff] text-[#0071e3]"><RefreshCw className="h-3.5 w-3.5" /></span><div className="min-w-0 flex-1"><p className="text-[8px] font-semibold text-[#1d1d1f]">Weekly story-health review</p><p className="mt-1 text-[7px] leading-3 text-[#86868b]">Friday · 16:00 · review latest pilot</p></div><button type="button" aria-label="Toggle scheduled task" aria-pressed={scheduleEnabled} onClick={onToggleSchedule} className={`relative h-4 w-7 shrink-0 rounded-full transition-colors active:scale-95 ${scheduleEnabled ? "bg-[#0071e3]" : "bg-[#d2d2d7]"}`}><span className={`absolute left-0.5 top-0.5 h-3 w-3 rounded-full bg-white shadow transition-transform ${scheduleEnabled ? "translate-x-3" : "translate-x-0"}`} /></button></div>
...
function AgentWorkspace({ view, selected, onOpenGroup }: { view: AgentView; selected: AgentId; onOpenGroup: () => void }) {
  if (view === "profile") {
    ...
    const chat = agentChats[selected];
    return (
      <div className="grid min-h-0 flex-1 bg-white lg:grid-cols-[minmax(0,1fr)_18rem]">
        <section className="flex min-h-0 min-w-0 flex-col border-r border-black/8">
          <div className="flex min-h-11 items-center gap-2 border-b border-black/8 px-4">
            <span className={`flex h-7 w-7 items-center justify-center rounded-lg text-[7px] font-bold ${agent.color}`}>{agent.initials}</span>
            <span className="text-[10px] font-semibold text-[#1d1d1f]">{agent.name}</span>
            <span className="text-[8px] text-[#86868b]">1:1 chat</span>
            <button onClick={onOpenGroup} type="button" className="ml-auto rounded-full border border-black/8 px-2.5 py-1.5 text-[8px] font-semibold text-[#515154] active:scale-95">Open in room</button>
          </div>
          <div className="min-h-0 flex-1 overflow-y-auto p-4 sm:p-6">
            <div className="space-y-5">
              {chat.map((message, index) => message.author === "user" ? (
                <div key={index} data-phai-transition className="flex justify-end">
                  <div className="max-w-[31rem] rounded-[1.05rem] bg-[#eaf4ff] px-4 py-3 text-[10px] leading-5 text-[#0066cc]">{message.text}</div>
                </div>
              ) : (
                <div key={index} data-phai-transition className="flex items-start gap-3">
                  <span className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-lg text-[7px] font-bold ${agent.color}`}>{agent.initials}</span>
                  <div>
                    <div className="flex items-baseline gap-2">
                      <p className="text-[9px] font-semibold text-[#1d1d1f]">{agent.name}</p>
                      <span className="text-[7px] text-[#b0b0b5]">now</span>
                    </div>
                    <p className="mt-2 max-w-[38rem] text-[10px] leading-5 text-[#515154]">{message.text}</p>
                    <p className="mt-2 inline-flex items-center gap-1.5 text-[7px] font-medium text-[#0071e3]"><CheckCircle2 className="h-3 w-3" />{message.thinking}</p>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="mx-4 mb-4 rounded-[1.1rem] border border-black/10 bg-white p-3 shadow-[0_10px_30px_rgba(0,0,0,0.055)] sm:mx-5">
            <p className="text-[9px] text-[#b0b0b5]">Message {agent.name}</p>
            <div className="mt-3 flex items-center gap-2">
              <Paperclip className="h-3.5 w-3.5 text-[#86868b]" />
              <button type="button" aria-label="Send" className="ml-auto flex h-7 w-7 items-center justify-center rounded-full bg-[#111318] text-white active:scale-90"><Send className="h-3 w-3" /></button>
            </div>
          </div>
        </section>
        <aside className="hidden min-h-0 overflow-y-auto bg-[#fbfbfc] lg:block">
          <div className="border-b border-black/8 p-3.5">
            <div className="flex items-center gap-2">
              <Bot className="h-3.5 w-3.5" />
              <p className="text-[9px] font-semibold text-[#1d1d1f]">About this agent</p>
            </div>
            <p className="mt-3 text-[9px] leading-5 text-[#515154]">{agent.description}</p>
            <p className="mt-4 text-[8px] font-semibold uppercase tracking-[0.12em] text-[#86868b]">Working style</p>
            <p className="mt-1.5 text-[9px] font-semibold text-[#1d1d1f]">{agent.tone}</p>
          </div>
          <div className="p-3.5">
            <p className="text-[8px] font-semibold uppercase tracking-[0.12em] text-[#86868b]">Personal Skills</p>
            <div className="mt-2 space-y-1.5">
              {agent.skills.map((skill) => (
                <div key={skill} className="flex items-center gap-2 text-[8px] text-[#515154]"><Wrench className="h-3 w-3 text-[#0071e3]" />{skill}</div>
              ))}
            </div>
          </div>
        </aside>
  ...
  return (
    <div className="grid min-h-0 flex-1 bg-white lg:grid-cols-[minmax(0,1fr)_18rem]">
      ...
      <aside className="hidden min-h-0 overflow-y-auto bg-[#fbfbfc] lg:block">
        <div className="border-b border-black/8 p-3.5"><div className="flex items-center gap-2"><FileCheck className="h-3.5 w-3.5 text-[#0071e3]" /><p className="text-[9px] font-semibold text-[#1d1d1f]">Output</p></div><p className="mt-3 text-[9px] font-semibold text-[#1d1d1f]">Scene 32 / Revised treatment</p><p className="mt-1.5 text-[8px] leading-4 text-[#515154]">The evidence bag is on the desk, but the label is wrong. Mid-shot on the bag. The suspect hesitates, then corrects the label. The detective hears it and smiles. End of scene, no dialogue reveal.</p><div className="mt-2.5 flex flex-wrap gap-1.5">{["5-shot coverage", "4 lines removed", "Scene 41 seed kept"].map((chip) => <span key={chip} className="rounded-full bg-white px-2 py-0.5 text-[7px] font-semibold text-[#515154] shadow-sm">{chip}</span>)}</div></div>
...
const sourceCharacterProfiles: Record<KnowledgeCharacterId, { name: string; initials: string; role: string; tags: string[]; color: string; avatar: string; sourceType: string; overview: string; sections: [string, string][]; relations: [string, string, string][] }> = {
  andy: {
    name: "Andrea “Andy” Sachs", initials: "AS", role: "Protagonist · second assistant · aspiring journalist", color: "from-[#dbeafe] to-[#93c5fd] text-[#0756a4]", avatar: "/images/characters/andy.png",
  ...
  miranda: {
    name: "Miranda Priestly", initials: "MP", role: "Key relationship profile · employer and transforming authority", color: "from-[#e5e7eb] to-[#9ca3af] text-[#26272a]", avatar: "/images/characters/miranda.png",
  ...
  nigel: {
    name: "Nigel", initials: "NG", role: "Key relationship profile · mentor and fashion-world transformer", color: "from-[#fef3c7] to-[#f59e0b] text-[#7c3d00]", avatar: "/images/characters/nigel.png",
  ...
  emily: {
    name: "Emily", initials: "EM", role: "Key relationship profile · workplace guide and direct competitor", color: "from-[#fce7f3] to-[#f9a8d4] text-[#9d174d]", avatar: "/images/characters/emily.png",
  ...
  nate: {
    name: "Nate", initials: "NT", role: "Key relationship profile · boyfriend and emotional anchor", color: "from-[#dcfce7] to-[#86efac] text-[#166534]", avatar: "/images/characters/nate.png",
...
function KnowledgeWorkspace({ category, detail, onDetail, tab, onTab, onCite, onUnavailable }: { category: string; detail: boolean; onDetail: (value: boolean) => void; tab: KnowledgeTab; onTab: (tab: KnowledgeTab) => void; onCite: () => void; onUnavailable: (title: string) => void }) {
  ...
  return (
    <section className="min-h-0 flex-1 overflow-y-auto bg-white p-4 sm:p-5">
      ...
      {visibleWorks.length > 0 ? <div data-phai-transition className="mt-4 grid gap-2 sm:grid-cols-2 xl:grid-cols-3">{visibleWorks.map((work, index) => <button key={work.title} type="button" onClick={() => work.title === "The Devil Wears Prada" ? onDetail(true) : onUnavailable(work.title)} className="group flex min-h-28 items-start gap-3 rounded-2xl border border-black/8 bg-white p-3 text-left shadow-[0_6px_18px_rgba(0,0,0,0.035)] transition hover:-translate-y-0.5 hover:shadow-[0_12px_28px_rgba(0,0,0,0.07)] active:scale-[0.98] motion-reduce:transform-none motion-reduce:transition-none"><span className="relative h-20 w-14 shrink-0 overflow-hidden rounded-lg bg-[#f5f5f7] shadow-sm ring-1 ring-black/5"><Image src={work.poster} alt={`${work.title} poster`} fill sizes="56px" className="object-cover" priority={index < 3} /><span className="absolute left-1 top-1 rounded bg-black/55 px-1 py-0.5 text-[5px] font-semibold text-white backdrop-blur-sm">{String(index + 1).padStart(2, "0")}</span></span><span className="min-w-0"><span className="block truncate text-[9px] font-semibold text-[#1d1d1f]">{work.title}</span><span className="mt-1 block text-[7px] text-[#0071e3]">{work.track} · {work.genre} · {work.year}</span><span className="mt-2 line-clamp-3 block text-[7px] leading-4 text-[#86868b]">{work.summary}</span></span></button>)}</div> : <div className="mt-16 text-center"><Library className="mx-auto h-8 w-8 text-[#d2d2d7]" /><p className="mt-3 text-[10px] font-semibold text-[#515154]">No titles match both filters.</p><button type="button" onClick={() => { setTrack("All tracks"); setGenre("All genres"); }} className="mt-3 text-[8px] font-semibold text-[#0071e3]">Reset filters</button></div>}
    </section>
  );
}

function ModelMarketplace({ selected, onSelect }: { selected: string; onSelect: (value: string) => void }) {
  const selectedMeta = models.find((model) => model.name === selected) ?? models[0];
  return (
    <section data-phai-transition className="flex min-h-0 flex-1 flex-col items-center justify-center overflow-y-auto bg-white px-5 py-8 text-center sm:py-10">
      <h3 className="text-2xl font-semibold tracking-[-0.04em] text-[#1d1d1f]">One workspace. Multiple model families.</h3>
      <div className="mt-7 flex max-w-4xl flex-wrap justify-center gap-2">{models.map((model, index) => <button key={model.name} type="button" onClick={() => onSelect(model.name)} className={`flex min-w-28 items-center gap-2 rounded-xl border p-2.5 text-left transition active:scale-[0.96] ${selected === model.name ? "border-[#0071e3] bg-[#eaf4ff] shadow-[0_8px_22px_rgba(0,113,227,0.12)]" : "border-black/8 bg-white hover:border-black/15"}`}><span className="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-lg bg-white"><Image src={model.logo} alt={`${model.name} logo`} width={28} height={28} className="h-7 w-7 object-contain" /></span><span><span className="block text-[8px] font-semibold text-[#1d1d1f]">{model.name}</span><span className="mt-0.5 block text-[7px] text-[#86868b]">{model.maker}</span></span></button>)}</div>
      <div className="mt-8 flex h-48 w-full max-w-4xl flex-col rounded-[1.5rem] border border-black/8 bg-white p-4 text-left shadow-[0_18px_50px_rgba(0,0,0,0.065)]">
        <p className="text-[10px] text-[#b0b0b5]">Select a model to start a conversation</p>
        <div className="mt-auto flex items-center gap-2 border-t border-black/8 pt-3">
          <Paperclip className="h-3.5 w-3.5 text-[#86868b]" />
          <span className="text-[8px] text-[#b0b0b5]">Attach a script</span>
          <div className="ml-auto flex items-center gap-2">
            <span className="flex items-center gap-1 rounded-full border border-black/8 bg-[#f5f5f7] px-2.5 py-1.5 text-[8px] font-semibold text-[#515154]">
              <span className="flex h-3.5 w-3.5 shrink-0 items-center justify-center overflow-hidden rounded"><Image src={selectedMeta.logo} alt="" width={14} height={14} className="h-3 w-3 object-contain" /></span>
              {selectedMeta.name}
            ...
            <button type="button" aria-label="Send prompt" disabled className="flex h-7 w-7 items-center justify-center rounded-full bg-[#d2d2d7] text-white"><Send className="h-3 w-3" /></button>
          </div>
        </div>
      </div>
    </section>
...
export function PhaiProductSimulator() {
  ...
  }, { scope: rootRef, dependencies: [mode, activeTool, chatId, agentView, selectedAgent, knowledgeDetail, knowledgeTab, selectedModel, skillFilter, reduceMotion], revertOnUpdate: true });
    ...
    <div ref={rootRef} className="mt-9 [overflow-anchor:none]">
      <div className="relative overflow-hidden rounded-[2rem] border border-black/10 bg-white shadow-[0_34px_100px_rgba(0,0,0,0.14)]">
        ...
        <div className={activeTool ? "flex h-[45rem] min-h-0 overflow-hidden" : "h-[45rem] min-h-0 overflow-hidden lg:grid lg:grid-cols-[15rem_minmax(0,1fr)] lg:grid-rows-[minmax(0,1fr)]"}>
          {activeTool === "models" ? <ModelMarketplace selected={selectedModel} onSelect={setSelectedModel} /> : activeTool === "skills" ? <SkillCenter filter={skillFilter} onFilter={setSkillFilter} search={skillSearch} onSearch={setSkillSearch} enabled={enabledSkills} onToggle={toggleSkill} /> : <>
